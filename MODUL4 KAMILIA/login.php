        ...
        <div class="card">
          <form action="loginauth.php" method="post">
            <div class="card-body">
              ...
              <hr>
              <h6>Email</h6>
              <input class="mb-1" style="width:100%" type="email" name="email" id="email" placeholder="Masukkan Alamat E-Mail" value="<?php if(isset($_COOKIE['email'])){echo $_COOKIE['email']; }?>" required>
              <h6>Kata Sandi</h6>
              <input class="mb-1" style="width:100%" type="password" name="password" id="password" placeholder="Kata Sandi Anda" value="<?php  if(isset($_COOKIE['password'])){echo $_COOKIE['password']; }?>" required>
              <br>
              <div class="mt-1">
