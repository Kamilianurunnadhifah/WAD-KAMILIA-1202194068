            ...
            <div class="card-body">
              ...
              <table>
                ...
                <tr>
                  ...
                  <td><input class="m-2 col-md-7" style="width:100%" type="text" name="nama" value="<?php echo $nama; ?>" id="nama" placeholder="Masukkan Nama Lengkap">
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td><input class="m-2" style="width:100%" type="number" name="no_hp" id="no_hp" value="<?php echo $no_hp; ?>" placeholder="Masukkan Nomor Handphone">
                  </td>
                </tr>
              </table>
              <hr class="ms-4 me-4">
              <table>
                <tr>
                  ...
                  <td> <input class="m-2" style="width:95%" type="text" name="password" id="password" onkeyup='check();' placeholder="Kata Sandi Anda">
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td><input class="m-2" style="width:95%" type="text" name="repassword" id="repassword" onkeyup='check();' placeholder="Konfirmasi Kata Sandi Anda">
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td><input class="m-2"style="width:95%"  type="text" name="warnanavbar" id="warnanavbar" value="Blue Ocean">
                  </td>
                </tr>
              </table>
              <br>
              ...
              <div class="row mt-0 mb-2">
                ...
                <div class="col-sm-2 col-md-2">
                  <button type="submit" class="ps-2 pe-2 btn btn-primary" style="text-align: center;"> Simpan </button>

                </div>
                <div class="col-sm-2 col-md-2">
                  <a href="javascript:history.go(-1)" class="ps-2 pe-2 btn btn-warning" style="text-align: center;"> Cancel </a>
