      ...
      <div class="card">
        <form action="registeracc.php" method="post">
          <div class="card-body">
            ...
            <hr>
            <h6>Nama</h6>
            <input class="mb-1" style="width:100%" type="text" name="nama" id="nama" placeholder="Masukkan Nama Lengkap" required>
            <h6>Email</h6>
            <input class="mb-1" style="width:100%" type="email" name="email" id="email" placeholder="Masukkan Alamat E-Mail" required>
            <h6>Nomor Handphone</h6>
            <input class="mb-1" style="width:100%" type="number" name="no_hp" id="no_hp" placeholder="Masukkan Nomor Handphone" required>
            <h6>Kata Sandi</h6>
            <input class="mb-1" style="width:100%" type="password" name="password" id="password" placeholder="Kata Sandi Anda" onkeyup='check();' required>
            <h6>Konfirmasi Kata Sandi</h6>
            <input class="mb-0" style="width:100%" type="password" name="repassword" id="repassword" placeholder="Konfirmasi Kata Sandi Anda" onkeyup='check();' required>
            <br>
            <br>
