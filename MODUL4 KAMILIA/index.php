...
<div class="d-flex justify-content-center align-items-center" style="margin-top: 15px;">
    <div class="row">
        <div>
            ...
            <div style="background-color: white;margin-left:10%;margin-right:auto;width:999px">
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <div class="m-3" style="width:300px">
                                ...
                                <p>
                                    Kepulauan Raja Ampat adalah kepulauan Indonesia di ujung barat laut Semenanjung
                                    Kepala Burung di Papua Barat. Terdiri dari ratusan pulau yang tertutup hutan, Raja
                                    Ampat dikenal dengan pantai dan terumbu karangnya yang kaya dengan kehidupan laut.
                                    Lukisan batu dan gua kuno berada di Pulau Misool, sedangkan cendrawasih merah hidup
                                    di Pulau Waigeo. Batanta dan Salawati adalah pulau-pulau utama lainnya di nusantara.
                                </p>
                                <hr>
                        ...
                        <td>
                            ...
                            <div class="m-3" style="width:300px">
                                ...
                                <p>
                                    Gunung Bromo adalah gunung berapi somma aktif dan bagian dari pegunungan Tengger, di
                                    Jawa Timur, Indonesia. Pada 2.329 meter itu bukan puncak tertinggi dari massif,
                                    tetapi yang paling terkenal. Kawasan ini merupakan salah satu destinasi wisata yang
                                    paling banyak dikunjungi di Jawa Timur, dan gunung berapi ini termasuk dalam Taman
                        ...
                        <td>
                            ...
                            <div class="m-3" style="width:300px">
                                ...
                                <p>
                                    Tanah Lot adalah formasi batuan di lepas pantai pulau Bali, Indonesia. Ini adalah
                                    rumah bagi kuil ziarah Hindu kuno Pura Tanah Lot, ikon wisata dan budaya yang
                                    populer untuk fotografi. Di sini ada dua pura yang terletak di atas batu besar. Satu
                                    terletak di atas bongkahan batu dan satunya terletak di atas tebing mirip dengan
                                    Pura Uluwatu. Pura Tanah Lot ini merupakan bagian dari pura Dang Kahyangan.</p>
                                <hr>
                    ...
                    <tr>
                        <td>
                            <a href="#" class="m-1 d-flex justify-content-center btn btn-primary" id="rajaampat"
                               style="text-align: center;<?php if (!isset($_SESSION['email'])) {
                                   echo 'pointer-events: none;';
                               } ?>"> Pesan Tiket </a>
                        </td>
                        <td>
                            <a href="#" class="m-1 d-flex justify-content-center btn btn-primary" id="bromo"
                               style="text-align: center;<?php if (!isset($_SESSION['email'])) {
                                   echo 'pointer-events: none;';
                               } ?>"> Pesan Tiket </a>
                        </td>
                        <td>
                            <a href="#" class="m-1 d-flex justify-content-center btn btn-primary" id="tanahlot"
                               style="text-align: center;<?php if (!isset($_SESSION['email'])) {
                                   echo 'pointer-events: none;';
                               } ?>"> Pesan Tiket </a>
                        </td>
        ...
        <?php if ((isset($_COOKIE['warna']) && $_COOKIE['warna'] == 'blueocean') || !isset($_COOKIE['warna'])) { ?>
            <div class="footer">
                <h6 style="text-align: center;" class="m-2">©2021 Copyright: <a href="#"
                                                                                class="logo">Kamilia_1202194068</a></h6>
            </div>
            <style>
                .footer {
                    width: 100%;
