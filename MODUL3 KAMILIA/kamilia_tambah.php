...
<head>
    ...
    <title>Kamilia - Tambah Buku</title>
</head>
...
<header class="p-3 bg-dark text-white mb-5">
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-between">
            <a href="kamilia_home.php" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
                <img src="https://hmsitel-u.id/wp-content/uploads/2021/01/logo-ead-1.png" height="32" alt="">
            </a>
            <a class="btn btn-primary" href="tambah.php" role="button">Tambah Buku</a>
        </div>
    </div>
</header>
<section class="container shadow-lg p-4 rounded-3">
    ...
    <form method="post" enctype="multipart/form-data" action="kamilia_action_tambah.php">
        <div class="mb-3">
            <label class="form-label fw-bold">Judul Buku</label>
            <input name="judul_buku" id="judul_buku" type="text" class="form-control"
                   placeholder="Contoh : Pemrograman Web bersama EAD"
                   value="<?php if (!empty($_SESSION['judul_buku'])) {
                       echo $_SESSION['judul_buku'];
                   } ?>">
        </div>
        <div class="mb-3">
            <label class="form-label fw-bold">Penulis</label>
            <input name="penulis_buku" type="text" class="form-control" placeholder="Kamilia_1202194068" readonly
                   value="Kamilia_1202194068">
        </div>
        <div class="mb-3">
            <label class="form-label fw-bold">Tahun Terbit</label>
            <input name="tahun_terbit" type="number" class="form-control" placeholder="Contoh: 1990"
                   value="<?php if (!empty($_SESSION['tahun_terbit'])) {
                       echo $_SESSION['tahun_terbit'];
                   } ?>">
        </div>
        <div class="mb-3">
            <label class="form-label fw-bold">Deskripsi</label>
            <textarea name="deskripsi" class="form-control"
                      placeholder="Contoh: Buku ini menjelaskan tentang ..."><?php if (!empty($_SESSION['deskripsi'])) {
        ...
        <div class="mb-3">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="bahasa"
                       value="Indonesia" <?php if (isset($bahasa) && $bahasa == "indonesia") {
                    echo "checked";
                } else if (!empty($_SESSION['bahasa']) == "indonesia") {
                    echo "checked";
                } ?>>
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="bahasa"
                       value="Lainnya" <?php if (isset($bahasa) && $bahasa == "lainnya") {
                    echo "checked";
                } else if (!empty($_SESSION['bahasa']) == "lainnya") {
                    echo "checked";
                } ?>>
...
<footer class="d-flex flex-column align-items-center pt-5 bottom-0 pb-5 mt-5 bg-light">
    ...
    <small class="text-muted">&copy; Kamilia_1902194068</small>
</footer>
