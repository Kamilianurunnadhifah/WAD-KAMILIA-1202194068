                ...
                <form action="my-booking.php" method="POST" class="pe-3 my-3 needs-validation">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="check1" value="1"
                                   id="flexCheckDefault">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="check2" value="2"
                                   id="flexCheckChecked">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="check3" value="3"
                                   id="flexCheckChecked">
                            <label class="form-check-label" for="flexCheckChecked">
                                Sound System / $250
                            </label>
